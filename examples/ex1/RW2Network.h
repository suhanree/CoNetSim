...
// Graphs for RW2.
// 	not defined here. It can be Graphs_Ex4, or Graphs_Ex5

//========<(3) Defining the RW2Network class>=========================================
// Network for RW2
class RW2Network: public Network2<RW2State> {
   public:
   	// Constructor.
	RW2Network(RW2Nodes &nn, RW2Links &ll, Graphs &gg, ParameterSet &p);
