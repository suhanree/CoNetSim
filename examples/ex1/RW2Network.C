...
// Network for RW2
// constructor
RW2Network::RW2Network(RW2Nodes &nn, RW2Links &ll, Graphs &gg, ParameterSet &p): conet::Network2<RW2State>(nn,ll,gg,p), 
...
// Initialize nodes.
void RW2Network::initialize_nodes() {
...
void RW2Network::initialize_links() {
...
// Create nodes.
void RW2Network::create_nodes(TimeType t) {
	if (t==0) {
...
void RW2Network::update_nodes(TimeType t) {
...
// Update graphs (rule-based).
void RW2Network::update_graphs(TimeType t) {
	...
	links.clear(0);
	create_links(t); // based on node states at t.
};

// Create links (rule-based).
void RW2Network::create_links(TimeType t) {
...
void RW2Network::write_nodes_T(Output &output, TimeType t, short method) {
	if (method==0) {
...
// Write outputs of this RW2 problem.
void RW2Network::write_output(TimeType t) {
...
// Write summary of this RW2 problem.
void RW2Network::write_summary(TimeType t, bool if_converged) {
	long ngroups=1;
	double ave_diff=0;
...
void RW2Network::write_network_stat(TimeType t) {
...
void RW2Network::update_occupancy(TimeType t) {
...
void RW2Network::find_neighbors(const Point2DTorus &p) {
	neighbors.clear();
	long index;
...
void RW2Network::print_occupancy() const {
	long size=occupancy.size();
...
RW2State RW2Network::next_state(NodeID id, TimeType t) {
	// Old values
...
double RW2Network::find_op_movement(double myop, long size) {
