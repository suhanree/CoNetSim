...
void InputParamEx1::read_all_parameters() {
...
int main(int argc, char **argv) {
	...
	// Getting the input parameters for Ex1.
	InputParamEx1 in_param(infile,param);
   ...
   try {
	...
	Ex1Network net(nodes,links,graphs,param);
